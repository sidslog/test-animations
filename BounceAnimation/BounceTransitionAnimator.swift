        ...
        if let from = transitionContext.viewControllerForKey(UITransitionContextFromViewControllerKey),
            ...
            let toView = to.view {
                ...
                if (self.presenting) {
                    ...
                    UIView.animateWithDuration(NSTimeInterval(self.duration), delay: NSTimeInterval(0), usingSpringWithDamping: CGFloat(0.4), initialSpringVelocity: CGFloat(0.4), options: UIViewAnimationOptions.allZeros, animations: { () -> Void in
                    ...
                    UIView.animateWithDuration(NSTimeInterval(self.duration), delay: NSTimeInterval(0), usingSpringWithDamping: CGFloat(1), initialSpringVelocity: CGFloat(1.0), options: UIViewAnimationOptions.allZeros, animations: { () -> Void in
